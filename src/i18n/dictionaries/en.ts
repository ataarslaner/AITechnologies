export const en = {
  ...
  common: {
    ...
    readMore: "Read more",
    scopeEngagement: "Scope an engagement",
    comingSoon: "Coming soon",
    notifyMe: "Notify me",
    sendToStudio: "Send to the studio",
    backHome: "Back to home",
    studioOpen: "Studio open · taking on three new partners this quarter",
    soon: "soon",
    house: "House",
  },
  nav: {
  ...
  home: {
    houseLabel: "House № 001",
    estLabel: "Est.",
    headlineA: "Engineered",
    headlineB: "to win.",
    sectionsServicesEyebrow: "Services",
    sectionsServicesTitle: "Four practices. One standard of work.",
    sectionsServicesIntro:
      "Each practice is a delivery team of senior engineers and applied scientists. We sign on numbers, not adjectives.",
    sectionsIndustriesEyebrow: "Industries",
    sectionsIndustriesTitle: "We work where the stakes are real.",
    sectionsIndustriesIntro:
      "Each engagement is private by default and tuned to the way your industry actually runs.",
    sectionsWorkEyebrow: "Selected work",
    sectionsWorkTitle: "Receipts, not slogans.",
    sectionsWorkIntro:
      "A few of the businesses we have rebuilt. Names withheld at partner request.",
    sectionsPrinciplesEyebrow: "House code",
    sectionsPrinciplesTitle: "Quiet rigor. Loud results.",
    ctaEyebrow: "Studio open",
    ctaTitle: "Have a problem worth solving? We are listening.",
    ctaBody:
      "Tell us the metric you want to move. We will tell you whether we can move it, and how fast.",
  },
  stats: [
    { value: "+50%", label: "Avg. revenue lift, legal partners" },
    { value: "+30%", label: "Avg. traffic lift, commerce partners" },
    { value: "12+", label: "Hours returned per lawyer, weekly" },
    { value: "30", label: "Languages our products speak" },
  ],
  marquee: [
    "Legal",
    "Commerce",
  ...
  pages: {
    services: {
      ...
      intro:
        "We are organized around the metrics our partners actually care about. Pick the practice or pick all four.",
    },
    industries: {
      eyebrow: "Industries",
      title: "We build where domain rigor meets real outcomes.",
      intro:
        "Legal teams keep their privilege, commerce teams keep their margin, clinicians keep their hours. The work shows up where it matters most.",
    },
    work: {
      eyebrow: "Work",
      title: "Receipts, not slogans.",
      intro:
        "A short ledger of recent engagements. Names withheld at partner request, numbers verified.",
    },
    journal: {
      eyebrow: "Journal",
    ...
    studio: {
      ...
      intro:
        "Ada House is a small, deliberate team. Engineers, applied scientists, designers, and operators who have shipped at hyperscale. We work in two-week cycles, in plain language, with the people who decide.",
      journeyEyebrow: "How we engage",
      journeyTitle: "From first call to first ship.",
    ...
    shop: {
      ...
      intro:
        "A small line of essentials with the Ada mark. Made for the long days and the focused ones. The house extends beyond the screen.",
      items: [
      ...
      newsletterTitle: "Be first in line.",
      newsletterBody:
        "Leave your email and we will send a single note when the first run is ready. No newsletters, no noise.",
    ...
    contact: {
      ...
      intro:
        "We will tell you whether we can move it, and how fast. Senior engineers respond, not bots.",
      studioCardEyebrow: "Studio",
      studioCardBody: "Remote-first. We meet partners where they are.",
      directCardEyebrow: "Direct",
      directCardBody: "For partnership and press inquiries.",
      formNameLabel: "Your name",
      formEmailLabel: "Email",
      formCompanyLabel: "Company",
      formIndustryLabel: "Industry · Legal, Commerce, Health, Other",
      formMessageLabel: "Project",
      formMessagePlaceholder:
        "What metric do you want to move? What is in your way?",
      formNote:
    ...
    notFound: {
      ...
      body: "The page you are looking for has drifted off. Let us get you back to somewhere useful.",
    },
  },
};
